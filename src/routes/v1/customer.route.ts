...
//     .post(validate(customerValidation.verifyWallet1), customerController.verifyWallet1);
// router
//     .route('/verify-wallet-2')
//     .post(validate(customerValidation.verifyWallet2), customerController.verifyWallet2);
