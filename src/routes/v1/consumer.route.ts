...
router
    .route(CONSUMER_ROUTES.signUp)
    .post(validate(consumerValidation.signUp), consumerAuthController.signUp);
router
    .route(CONSUMER_ROUTES.verifyOTP)
    .post(validate(consumerValidation.verifyOTP), consumerAuthController.verifyOTP);

router
    .route(CONSUMER_ROUTES.login)
    .post(validate(consumerValidation.login), consumerAuthController.login);
